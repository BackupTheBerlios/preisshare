...
const
    sWindowsSocketError = 'Windows socket error';
    sASyncSocketError = 'Windows socket error';
    sNoAddress = 'Windows socket error';
    sCannotListenOnOpen = 'sCannotListenOnOpen';
    sCannotCreateSocket = 'sCannotCreateSocket';
    sSocketAlreadyOpen = 'SocketAlreadyOpen';
    sCantChangeWhileActive = 'CantChangeWhileActive';
    sSocketMustBeBlocking = 'SocketMustBeBlocking';
    sSocketIOError = 'SocketIOError';
    sSocketRead = 'SocketRead';
    sSocketWrite = 'SocketWrite';
