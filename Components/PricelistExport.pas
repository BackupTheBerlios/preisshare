...
// Pricelist Fields
	...
	PRICELIST_EXPORTMAP_PRODUCT_SELL    = '@' + GTD_PL_ELE_PRODUCT_SELL;    //     = 'Your_Price';
...
begin
    ...
    fDocRegistry.GetSettingMemoString('/Column Mappings',GTD_PL_ELE_PRODUCT_SELL,s);
    if (s <> '') then
        AddItemFieldMapping(s, PRICELIST_EXPORTMAP_PRODUCT_SELL,'Currency');    //     = 'Product_Sell';
...
var
    ...
    begin
        for xc := 0 to ItemOutputFieldMappings.Count-1 do
        begin
            if ItemOutputFieldMappings[xc] = PRICELIST_EXPORTMAP_PRODUCT_SELL then
            begin
...
begin
    ...
    try
		...
		begin
            ...
            newItem.SubItems.Add(ProductNode.ReadStringField(GTD_PL_ELE_PRODUCT_SELL));
...
//            end;
            ...
            pbuy    := thisproduct.ReadStringField(GTD_PL_ELE_PRODUCT_SELL);
            if (pbuy = '') then
