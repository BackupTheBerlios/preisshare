...
type
  ...
  TTPricelistExportConfigFrame = class(TFrame)
...
{$R *.DFM}
function TTPricelistExportConfigFrame.OpenUserdb:Boolean;
begin
...
procedure TTPricelistExportConfigFrame.bsSkinButton1Click(Sender: TObject);
begin
    OpenUserdb;
...
procedure TTPricelistExportConfigFrame.ReadTableNames;
var
...
procedure TTPricelistExportConfigFrame.DisplayProductTableFields;
...
procedure TTPricelistExportConfigFrame.rdodbTypedBaseClick(Sender: TObject);
begin
...
procedure TTPricelistExportConfigFrame.rdodbTypeBorlandBDEClick(Sender: TObject);
begin
...
procedure TTPricelistExportConfigFrame.rdodbTypeAccessClick(Sender: TObject);
begin
...
procedure TTPricelistExportConfigFrame.rdoTypeCSVClick(Sender: TObject);
begin
...
procedure TTPricelistExportConfigFrame.txtCSVFileButtonClick(Sender: TObject);
var
    xc,xd,sl : Integer;
    s  : String;
begin
...
function TTPricelistExportConfigFrame.ReadTextFileLine(Dest : TStringList; const L : String):Boolean;
const
    lDelim = #13#10;
var
...
procedure TTPricelistExportConfigFrame.bsTableListListBoxClick(Sender: TObject);
var
    tablename : String;
    xc : Integer;
begin
...
procedure TTPricelistExportConfigFrame.CloseUserdb;
begin
...
procedure TTPricelistExportConfigFrame.bsSkinButton8Click(Sender: TObject);
begin
    CloseUserdb;
end;

procedure TTPricelistExportConfigFrame.txtAccessdbButtonClick(Sender: TObject);
begin
...
procedure TTPricelistExportConfigFrame.cbxProductGroupTableChange(Sender: TObject);
begin
...
procedure TTPricelistExportConfigFrame.cbxProductTableChange(Sender: TObject);
begin
...
procedure TTPricelistExportConfigFrame.LoadFieldList(TableName : String; AddTableName : Boolean; StringListDest : TStrings);
var
    xc : Integer;
begin
...
procedure TTPricelistExportConfigFrame.cbxSupplierTableChange(Sender: TObject);
begin
...
procedure TTPricelistExportConfigFrame.SetupProductFieldList;
...
procedure TTPricelistExportConfigFrame.nbkMainChanging(Sender: TObject;
  var AllowChange: Boolean);
begin
    SetupProductFieldList;
end;

procedure TTPricelistExportConfigFrame.cbxImport1LevelStockTableClick(
  Sender: TObject);
var
    ShowIt : Boolean;
begin
...
procedure TTPricelistExportConfigFrame.cbxImport2LevelStockTableClick(
  Sender: TObject);
var
    ShowIt : Boolean;
begin
...
procedure TTPricelistExportConfigFrame.cbxImportGroupStockTablesClick(
  Sender: TObject);
var
    ShowIt : Boolean;
begin
...
procedure TTPricelistExportConfigFrame.cbxImportGroupSubGroupStockTableClick(
  Sender: TObject);
var
    ShowIt : Boolean;
begin
...
function TTPricelistExportConfigFrame.ApplyTradalog:Boolean;
var
...
function TTPricelistExportConfigFrame.OpenTradalog(myDoc : GTDBizDoc):Boolean;
var
...
procedure TTPricelistExportConfigFrame.SetSkinData(Value: TbsSkinData);
...
begin
	...
	btnSaveMapping.SkinData := Value;

	SkinaPanel(pnlDbType);
	SkinaPanel(pnldbTypeScrolly);

	SkinaPanel(pnldbParams);
	bsSkinLabel16.SkinData := Value;
	bsSkinLabel17.SkinData := Value;
	cbxBDEALIAS.SkinData := Value;
	bsSkinLabel21.SkinData := Value;
	bsSkinLabel23.SkinData := Value;
	txtCSVFile.SkinData := Value;
	txtAccessdb.SkinData := Value;
	bsSkinButton10.SkinData := Value;
	txtdbaseDir.SkinData := Value;
	bsSkinButton1.SkinData := Value;
	bsSkinButton8.SkinData := Value;

	SkinaPanel(pnldbContents);
	SkinaPanel(pnlTableStructInfo);
	SkinaPanel(pnlTableMap);
	SkinaPanel(pnlUpdateRules);
	bsSkinButton13.SkinData := Value;
	SkinaPanel(pnlNewProductOpts);

	//SkinaPanel(pgColumnMappings);
	bsSkinLabel4.SkinData := Value;
	lstInputFields.SkinData := Value;
	bsSkinLabel7.SkinData := Value;
	dbgViewData.SkinData := Value;
	bsSkinLabel5.SkinData := Value;
	grdFieldMappings.SkinData := Value;
	mmoQuery.SkinData := Value;
	btnAddColumnMap.SkinData := Value;
	btnRemoveColumnMap.SkinData := Value;
	bsSkinButton7.SkinData := Value;
	mmoQuery.SkinData := Value;
	btnNext4.SkinData := Value;
	bsSkinButton12.SkinData := Value;
...
function TTPricelistExportConfigFrame.InitPatchRun:Boolean;
begin
end;

function TTPricelistExportConfigFrame.LoadTradalogCodes:Boolean;
var
    myList : TStringList;
...
function TTPricelistExportConfigFrame.LoadInventoryCodes:Boolean;
var
    SQLs,pcode : String;
    myDS : TDataSet;
    myList : TStringList;
...
function TTPricelistExportConfigFrame.FindAdditionsRemovals:Boolean;
...
function TTPricelistExportConfigFrame.LoadTradalogItemDetails:Boolean;
begin
    Result := False;
    Result := True;
end;

function TTPricelistExportConfigFrame.LoadInventoryItemDetails:Boolean;
begin
    Result := False;
    Result := True;
end;

function TTPricelistExportConfigFrame.FindFieldChanges:Boolean;
begin
    Result := False;
...
function TTPricelistExportConfigFrame.ResortOnProductCode:Boolean;
begin
    Result := False;
    Result := True;
end;

function TTPricelistExportConfigFrame.DetermineUpdateQueries:Boolean;
var
    sql : String;
...
function TTPricelistExportConfigFrame.ApplyUpdates:Boolean;
var
    xc : Integer;
begin
    Result := False;
...
procedure TTPricelistExportConfigFrame.Init;
begin
...
function TTPricelistExportConfigFrame.Run:Boolean;
begin
    Result := False;
...
procedure TTPricelistExportConfigFrame.BuildReport(const mType : String; const Msg : String);
begin
end;

function TTPricelistExportConfigFrame.LoadImportMapping(MapName : String):Boolean;
...
function TTPricelistExportConfigFrame.SaveImportMapping(MapName : String):Boolean;
var
    defmemo : TMemoField;
begin
    // -- Open the table if not already so
...
procedure TTPricelistExportConfigFrame.btnProcessClick(Sender: TObject);
begin
    Run;
end;

// -- Here we look up what a column should be translated to
function TTPricelistExportConfigFrame.FindColumnNameOf(ADefinedElementName : String):String;
var
    xc, xd : Integer;
    c       : String;
begin
...
procedure TTPricelistExportConfigFrame.btnAddColumnMapClick(Sender: TObject);
begin
...
procedure TTPricelistExportConfigFrame.btnRemoveColumnMapClick(Sender: TObject);
begin
    // -- Now copy over this field into our mapping list
...
procedure TTPricelistExportConfigFrame.btnSaveMappingClick(Sender: TObject);
begin
    // --
...
procedure TTPricelistExportConfigFrame.cbxHaveSupplierTableClick(Sender: TObject);
var
    onoroff : Boolean;
begin
...
procedure TTPricelistExportConfigFrame.lstMappingsListBoxDblClick(Sender: TObject);
begin
...
procedure TTPricelistExportConfigFrame.SetupBlankTableNames;
const
...
procedure TTPricelistExportConfigFrame.Clear;
begin
    cbxProductGroupTable.Text := '';

end;

procedure TTPricelistExportConfigFrame.btnNext2Click(Sender: TObject);
begin
    SetupBlankTableNames;
    nbkMain.ActivePageIndex := 2;
end;

function TTPricelistExportConfigFrame.ExportToDB:Boolean;
begin
end;

function TTPricelistExportConfigFrame.ExportToCSV:Boolean;
begin
end;
