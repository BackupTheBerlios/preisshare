...
var
    ...
    begin
        ...
        begin
            ...
            // -- Build the query
            SQL.Clear;
            SQL.Add('select ' + PLU_Col + ', ' + PProdTblName + '.' + PName_Col + ', ' + PPrice);
...
{
	GTD_PL_ELE_PRODUCT_CODE     = 'Product_ID';
	...
	GTD_PL_ELE_PRODUCT_SELL     = 'Your_Price';
	...
	GTD_PL_ELE_BRANDNAME        = 'Brand_Name';
	GTD_PL_ELE_MANUFACT_NAME    = 'Manufacturer_Name';
