...
uses
  Windows, Messages, SysUtils, Classes, SvcMgr, CustomerLinks;
...
type
  ...
  private
    FTcpDaemon : TCustomerTcpListener;
    FHttpDaemon : TCustomerHttpListener;
...
begin
    NetAccounts.Controller(CtrlCode);
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function TNetAccounts.GetServiceController: TServiceController;
begin
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TNetAccounts.ServiceStart(Sender: TService; var Started: Boolean);
begin
    try
        FTcpDaemon.Start;
        FHttpDaemon.Start;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TNetAccounts.ServiceStop(Sender: TService; var Stopped: Boolean);
begin
    fHttpDaemon.Stop;
    FTcpDaemon.Stop;
    Stopped := TRUE;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TNetAccounts.ServiceExecute(Sender: TService);
begin
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TNetAccounts.Display(Msg : String);
begin
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TNetAccounts.ServiceCreate(Sender: TObject);
begin
    FTcpDaemon           := TCustomerTcpListener.Create;
    FHttpDaemon          := TCustomerHttpListener.Create;
    FTcpDaemon.Banner    := DisplayName + ' Ready';
    FTcpDaemon.OnDisplay := Display;
end;

{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TNetAccounts.ServiceDestroy(Sender: TObject);
begin
    if Assigned(FTcpDaemon) then begin
        FTcpDaemon.Destroy;
        FTcpDaemon := nil;
    end;
    if Assigned(FHTTPDaemon) then begin
        FHttpDaemon.Destroy;
        FHttpDaemon := nil;
    end;
end;
